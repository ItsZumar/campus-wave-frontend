      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <InfoRow icon="🏛️" label="Department" value={user?.department ?? "—"} />
            <Divider />
            <InfoRow icon="📚" label="Semester" value={user?.semester ? `Semester ${user.semester}` : "—"} />
            <Divider />
            <InfoRow icon="🏷️" label="Section" value={user?.section ? `Section ${user.section}` : "—"} />
            <Divider />
            <InfoRow icon="🎓" label="Joined" value={joinedYear} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <OptionRow icon="✏️" label="Edit Profile" onPress={() => router.push("/edit-profile" as any)} showChevron />
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.infoCard}>
            <OptionRow icon="🚪" label="Logout" onPress={handleLogout} danger />
          </View>
        </View>
